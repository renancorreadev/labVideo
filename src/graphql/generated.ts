...
export type CreateSubsMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;
...
export const CreateSubsDocument = gql`
  ...
  createSubscriber(data: {name: $name, email: $email}) {
    ...
    `;
export type CreateSubsMutationFn = Apollo.MutationFunction<CreateSubsMutation, CreateSubsMutationVariables>;

/**
 * __useCreateSubsMutation__
 *
 * To run a mutation, you first call `useCreateSubsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubsMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubsMutation, { data, loading, error }] = useCreateSubsMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSubsMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubsMutation, CreateSubsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubsMutation, CreateSubsMutationVariables>(CreateSubsDocument, options);
      }
